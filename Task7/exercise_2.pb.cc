...
const uint32_t TableStruct_exercise_5f2_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::exercise_2::FullName)},
  { 12, -1, -1, sizeof(::exercise_2::Student)},
  { 21, -1, -1, sizeof(::exercise_2::StudentsGroup)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_exercise_5f2_2eproto = {
  false, false, 259, descriptor_table_protodef_exercise_5f2_2eproto, "exercise_2.proto", 
  &descriptor_table_exercise_5f2_2eproto_once, nullptr, 0, 3,
  schemas, file_default_instances, TableStruct_exercise_5f2_2eproto::offsets,
  file_level_metadata_exercise_5f2_2eproto, file_level_enum_descriptors_exercise_5f2_2eproto, file_level_service_descriptors_exercise_5f2_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_exercise_5f2_2eproto_getter() {
  return &descriptor_table_exercise_5f2_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_exercise_5f2_2eproto(&descriptor_table_exercise_5f2_2eproto);
namespace exercise_2 {
...
::PROTOBUF_NAMESPACE_ID::Metadata FullName::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_exercise_5f2_2eproto_getter, &descriptor_table_exercise_5f2_2eproto_once,
      file_level_metadata_exercise_5f2_2eproto[0]);
}
...
// @@protoc_insertion_point(message_byte_size_start:exercise_2.Student)
  ...
  // uint32 avg_score = 3;
  if (this->_internal_avg_score() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_avg_score());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata Student::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_exercise_5f2_2eproto_getter, &descriptor_table_exercise_5f2_2eproto_once,
      file_level_metadata_exercise_5f2_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata StudentsGroup::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_exercise_5f2_2eproto_getter, &descriptor_table_exercise_5f2_2eproto_once,
      file_level_metadata_exercise_5f2_2eproto[2]);
}
